...
{
    public partial class MTA_Simulator : Form
    {
        private Color BarvaKruh = Color.Transparent;
        ...
        public MTA_Simulator()
        {
            InitializeComponent();
            pnlStatus.Invalidate(); // Vynutí vykreslení
            LoadCsvData();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            BarvaKruh = Color.Red; // Výchozí stav = odpojeno
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            if (btnConnect.Text == "Připojit")
            {
                ...
                try
                {
                    ...
                    lblStatus.Text = "Připojeno, čekám na data...";
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            lblStatus.Text = $"Simulace běží: {selectedSensor}";
            BarvaKruh = Color.Green;
            pnlStatus.Invalidate();
        }
        ...
        private void btnStop_Click(object sender, EventArgs e)
        {
            ...
            lblStatus.Text = "Simulace zastavena.";
            selectedSensor = "";
            BarvaKruh = Color.Orange;
            pnlStatus.Invalidate();
        }
        ...
        {
            int size = Math.Min(pnlStatus.Width, pnlStatus.Height);
            SolidBrush brush = new SolidBrush(BarvaKruh);
            Pen pen = new Pen(Color.Black, 1);

            e.Graphics.FillEllipse(brush, (pnlStatus.Width - (size + 1)) / 2, (pnlStatus.Height - size) / 2, size - 5, size - 5);
            e.Graphics.DrawEllipse(pen, (pnlStatus.Width - (size + 1)) / 2, (pnlStatus.Height - size) / 2, size - 5, size - 5);
        }
